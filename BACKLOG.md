...
- Live-test `sdcard-current-object-thumbnail` from the laptop and record the resulting state/evidence.
...
- Probe the named `sdcard-current-object-thumbnail` sequence from the laptop.

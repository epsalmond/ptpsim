...
| `ConnectionInfo.command_listener_volatile` | whether closing the active PTP/IP transport removes the command listener, making close-and-reopen an invalid mode-switch fallback |

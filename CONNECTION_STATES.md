...
If the screen classifier returns `camera_screen_state=unknown`, stop the workflow. Fix the classifier/templates or LCD/iPhone alignment and rerun classification; do not manually interpret the image as connection-state evidence.

...
| `D212_HETEROGENEOUS_RECORDS_20260719.md` | Public byte-level reduction of the complete D22F-only and mixed numeric/PTP-string app-persona `0xD212` snapshots, including the typed member-absence boundary. |

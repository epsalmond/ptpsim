...
`sdcard-current-object-info` extends that sequence with `FujiVendor_9054` parameter `0x10000001`, which reference app used to read current-object metadata such as `20260425T095812,DSCF8101.MOV`.

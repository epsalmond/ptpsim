#!/usr/bin/env python3
"""Paced PTP-IP session vs a wireless-tether test camera (10.42.0.169:15740) using
Fuji VENDOR codes — probes whether the firmware routes vendor ops via a different
dispatch path than standard ops. READ-ONLY, paced ~7 s between ops.
...
def main():
    ...
    log(f"BEGIN paced_vendor_probe vs {CAM} (my_ip={my_ip})")

...
CAPTURED_HEX = "d0d48a164c3fffb62100000000000000ea070501001a0e"


class PayloadTests(unittest.TestCase):
    def test_decode_captured_location_payload(self) -> None:
        payload = decode_location(bytes.fromhex(CAPTURED_HEX))
        self.assertEqual(payload.latitude, 37.81972)
        self.assertEqual(payload.longitude, -122.47861)
    ...
    def test_parse_payload_hex_allows_spaces(self) -> None:
        payload = "d0 d4 8a 16 4c 3f ff b6 21 00 00 00 00 00 00 00 ea 07 05 01 00 1a 0e"
